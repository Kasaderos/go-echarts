...
<p align="center">
    <a href="https://github.com/kasaderos/go-echarts/actions/workflows/ci.yml">
        <img src="https://github.com/kasaderos/go-echarts/actions/workflows/ci.yml/badge.svg" alt="Build Status">
    </a>
    <a href="https://goreportcard.com/report/github.com/kasaderos/go-echarts">
        <img src="https://goreportcard.com/badge/github.com/kasaderos/go-echarts" alt="Go Report Card">
    </a>
	<a href="https://github.com/kasaderos/go-echarts/pulls">
        <img src="https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat" alt="Contributions welcome">
    </a>
    <a href="https://opensource.org/licenses/MIT">
        <img src="https://img.shields.io/badge/License-MIT-brightgreen.svg" alt="MIT License">
    </a>
    <a href="https://pkg.go.dev/github.com/kasaderos/go-echarts/v2">
        <img src="https://godoc.org/github.com/kasaderos/go-echarts?status.svg" alt="GoDoc">
    </a>
</p>
...
$ go get -u github.com/kasaderos/go-echarts/...
...
```shell
$ go get -u github.com/kasaderos/go-echarts/v2/...
```
...
require github.com/kasaderos/go-echarts/v2
```
...
import (
	...
	"github.com/kasaderos/go-echarts/v2/charts"
...
For more information, please refer to [go-echarts/examples](https://github.com/go-echarts/examples) and the [GoDoc](https://pkg.go.dev/github.com/kasaderos/go-echarts/v2).
...
Code with ❤️ by [chenjiandongx](https://github.com/chenjiandongx) / [Koooooo-7](https://github.com/Koooooo-7) and lovely [contributors](https://github.com/kasaderos/go-echarts/graphs/contributors)
